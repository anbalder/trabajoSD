...
public class Funciones {
	...
	public boolean comprobarResponsive(String html, String url) {
		//Escribo la forma tipica de meter boostrap, si el dueño de la pagina lo ha cambiado de nombre debere comprobarlo (comprobarlo como css normal).
	...
	public String buscarEmail(String html){
		...
		//Si no encuenta un email se encontraran las url del html y se buscara por ellas (solo en las que se indique en el filtro de la fuencion)	
